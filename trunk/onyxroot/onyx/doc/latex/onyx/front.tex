...
Onyx came in to existence when the author started working on a text editor
(since mothballed) that was meant to be extensible.  One of the goals was to
provide robust multi-threading.  Unfortunately, when work began on the text
editor in 1999, the author was unable to find any embeddable scripting languages
that provided adequate support for threads.  Thus Onyx was born.  The author was
