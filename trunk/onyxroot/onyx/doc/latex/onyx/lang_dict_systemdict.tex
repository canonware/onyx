...
\optableent
	{prog}
	{{\bf \htmlref{path}{systemdict:path}}}
	{path/null}
...
\optableent
	{\$SIG\_GETMASK oset}
	{{\bf \htmlref{sigmask}{systemdict:sigmask}}}
	{oset}
	{Get signal mask.}
\optableent
	{how set}
...
\optableent
	{set}
	{{\bf \htmlref{sigpending}{systemdict:sigpending}}}
	{set}
	{Get pending signals.}
\hline
\optableent
	{set}
	{{\bf \htmlref{sigsuspend}{systemdict:sigsuspend}}}
	{--}
	{Suspend until interrupted by a signal.}
\hline
\optableent
	{set}
	{{\bf \htmlref{sigwait}{systemdict:sigwait}}}
	{sig}
	{Wait for a signal.}
\hline
\optableent
...
\optableent
	{pid}
	{{\bf \htmlref{getpgid}{systemdict:getpgid}}}
	{pgid}
	{Get process group ID.}
\hline
\optableent
	{pid pgid}
	{{\bf \htmlref{setpgid}{systemdict:setpgid}}}
	{--}
	{Set process group ID.}
\hline
\optableent
	{pid}
	{{\bf \htmlref{getsid}{systemdict:getsid}}}
	{sid}
	{Get session ID.}
\hline
\optableent
	{--}
	{{\bf \htmlref{setsid}{systemdict:setsid}}}
	{sid}
	{Create new session.}
\hline
\optableent
...
\index{getpgid@\onyxop{}{getpgid}{}}
\item[{\onyxop{pid}{getpgid}{pgid}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[pid: ]
			Process ID, or 0 (same as specifying the calling
			process's ID).
		\end{description}
	\item[Output(s): ]
		\begin{description}\item[]
	...
	\item[Error(s): ]
		...
		\end{description}
	\item[Description: ]
		Get the process group ID for the process with ID \oparg{pid}.
	\item[Example(s): ]\begin{verbatim}
...
\index{getsid@\onyxop{}{getsid}{}}
\item[{\onyxop{pid}{getsid}{sid}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[pid: ]
	...
	\item[Error(s): ]
		...
		\end{description}
	\item[Description: ]
		Get the session ID for the process with ID \oparg{pid}.
	\item[Example(s): ]\begin{verbatim}
...
\item[{\onyxop{prog}{path}{path/null}}: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[path: ]
			A string that specifies the path to \oparg{prog}.
		\item[null: ]
			\oparg{prog} was not found.
		\end{description}
	\item[Error(s): ]
		\begin{description}\item[]
		\item[\htmlref{stackunderflow}{stackunderflow}.]
		...
		\end{description}
	\item[Description: ]
		Search for \oparg{prog} in the PATH, and return a string that is
		suitable for subsequent calls to operators such as
		\htmlref{\onyxop{}{exec}{}}{systemdict:exec},
		\htmlref{\onyxop{}{forkexec}{}}{systemdict:forkexec}, and
		\htmlref{\onyxop{}{system}{}}{systemdict:system}.
	\item[Example(s): ]\begin{verbatim}
...
\index{setpgid@\onyxop{}{setpgid}{}}
\item[{\onyxop{pid pgid}{setpgid}{--}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[pid: ]
...
\index{setsid@\onyxop{}{setsid}{}}
\item[{\onyxop{--}{setsid}{sid}}: ]
	\begin{description}\item[]
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
...
\item[{\onyxop{how set oset}{sigmask}{oset}}: ]
	...
	\item[Input(s): ]
		...
		\item[how: ] A name object:
			...
			\item[\$SIG\_BLOCK: ]
				...
				signals in \oparg{set} whose values are set to
				true.
			\item[\$SIG\_UNBLOCK: ]
				Unmask the signals in \oparg{set} whose values
				are set to true.
			\item[\$SIG\_GETMASK: ]
				Get the current signal mask.
			\item[\$SIG\_SETMASK: ]
				Set the signal mask to the signals in
				\oparg{set} whose values are set to true.
			\end{description}
		\item[set: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[oset: ]
			The same dictionary as was passed in as \oparg{oset}.
		\end{description}
	\item[Error(s): ]
		\begin{description}\item[]
		\item[\htmlref{argcheck}{argcheck}.]
...
\index{sigpending@\onyxop{}{sigpending}{}}
\item[{\onyxop{set}{sigpending}{set}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[set: ]
			The same dictionary as the input \oparg{set}.  A
			dictionary of signal name keys, with associated true
			values.  A value of true indicates set membership.  The
			supported names are:
			\begin{itemize}
			\item{\$SIGABRT}
			\item{\$SIGALRM}
...
\index{sigsuspend@\onyxop{}{sigsuspend}{}}
\item[{\onyxop{set}{sigsuspend}{--}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[set: ]
	...
	\item[Error(s): ]
		...
		\end{description}
	\item[Description: ]
		Suspend the calling thread until one of the signals in
		\oparg{set} is caught.
	\item[Example(s): ]\begin{verbatim}
...
\index{sigwait@\onyxop{}{sigwait}{}}
\item[{\onyxop{set}{sigwait}{sig}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[set: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[sig: ]
			One of the signal names that was specified in
			\oparg{set}.
		\end{description}
	\item[Error(s): ]
		\begin{description}\item[]
		...
		\end{description}
	\item[Description: ]
		Wait for one of the signals in \oparg{set}, and return the name
