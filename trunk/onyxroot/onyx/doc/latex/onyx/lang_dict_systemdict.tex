...
onyx:0>
		\end{verbatim}
	\end{description}
\label{systemdict:signalthread}
\index{signalthread@\onyxop{}{signalthread}{}}
\item[{\onyxop{OPARGS}{signalthread}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{sigpending}{OPOUTS}}: ]
	...
	\item[Example(s): ]\begin{verbatim}
		...
		\end{verbatim}
	\end{description}
\label{systemdict:sigprocmask}
\index{sigprocmask@\onyxop{}{sigprocmask}{}}
\item[{\onyxop{\$SIG\_GETMASK oset}{sigprocmask}{oset}}: ]
\item[{\onyxop{how set}{sigprocmask}{--}}: ]
\item[{\onyxop{how set oset}{sigprocmask}{oset}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[\$SIG\_GETMASK: ]
			A name object that tells the operator to take no action,
			except to return the signal mask.
	...
	\item[Error(s): ]
		...
		\end{description}
	\item[Description: ]
		Get or set the current signal mask.
	\item[Example(s): ]\begin{verbatim}
