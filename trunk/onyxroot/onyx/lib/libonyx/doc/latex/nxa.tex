...
\citem{\cppmacro[cw\_nxo\_t *]{nxa\_gcdict\_get}{cw\_nxa\_t *a\_nxa}}
	...
	\end{capilist}
\label{nxa_chi_get}
\index{\cppmacro{nxa\_chi\_get}{}}
\citem{\cppmacro[cw\_chi\_t *]{nxa\_chi\_get}{cw\_nxa\_t *a\_nxa}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxa: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[retval: ]
			Pointer to a \htmlref{\classname{chi}}{chi}.
		\end{description}
	\item[Exception(s): ]
		\begin{description}\item[]
		\item[\htmlref{\_CW\_STASHX\_OOM}{_CW_STASHX_OOM}.]
		\end{description}
	\item[Description: ]
		Allocate a \classname{chi} and return a pointer to it.
	\end{capilist}
\label{nxa_chi_put}
\index{\cppmacro{nxa\_chi\_put}{}}
\citem{\cppmacro[void]{nxa\_chi\_put}{cw\_nxa\_t *a\_nxa, cw\_chi\_t *a\_chi}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxa: ]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Deallocate a \classname{chi} that was allocated with
		\cppmacro{cnxa\_chi\_get}{}.
	\end{capilist}
\label{nxa_dicto_get}
\index{\cppmacro{nxa\_dicto\_get}{}}
\citem{\cppmacro[cw\_dicto\_t *]{nxa\_dicto\_get}{cw\_nxa\_t *a\_nxa}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxa: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[retval: ]
			Pointer to a \htmlref{\classname{dicto}}{dicto}.
		\end{description}
	\item[Exception(s): ]
		\begin{description}\item[]
		\item[\htmlref{\_CW\_STASHX\_OOM}{_CW_STASHX_OOM}.]
		\end{description}
	\item[Description: ]
		Allocate a \classname{dicto} and return a pointer to it.
	\end{capilist}
\label{nxa_dicto_put}
\index{\cppmacro{nxa\_dicto\_put}{}}
\citem{\cppmacro[void]{nxa\_dicto\_put}{cw\_nxa\_t *a\_nxa, cw\_dicto\_t
*a\_dicto}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Deallocate a \classname{dicto} that was allocated with
		\cppmacro{cnxa\_dicto\_get}{}.
	\end{capilist}
\label{nxa_stackc_get}
\index{\cppmacro{nxa\_stackc\_get}{}}
\citem{\cppmacro[cw\_stackc\_t *]{nxa\_stackc\_get}{cw\_nxa\_t *a\_nxa}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxa: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[retval: ]
			Pointer to a \htmlref{\classname{stackc}}{stackc}.
		\end{description}
	\item[Exception(s): ]
		\begin{description}\item[]
		\item[\htmlref{\_CW\_STASHX\_OOM}{_CW_STASHX_OOM}.]
		\end{description}
	\item[Description: ]
		Allocate a \classname{stackc} and return a pointer to it.
	\end{capilist}
\label{nxa_stackc_put}
\index{\cppmacro{nxa\_stackc\_put}{}}
\citem{\cppmacro[void]{nxa\_stackc\_put}{cw\_nxa\_t *a\_nxa, cw\_stackc\_t
*a\_stackc}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Deallocate a \classname{stackc} that was allocated with
		\cppmacro{cnxa\_stackc\_get}{}.
	\end{capilist}
\end{capi}
