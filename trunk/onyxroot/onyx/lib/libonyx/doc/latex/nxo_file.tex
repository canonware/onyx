...
\citem{\cfunc[void]{nxo\_file\_new}{cw\_nxo\_t *a\_nxo, cw\_bool\_t a\_locking}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
cw\_uint8\_t **r\_origin, cw\_uint32\_t *r\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[cw\_bool\_t]{nxo\_file\_origin\_set}{cw\_nxo\_t *a\_nxo,
const cw\_uint8\_t *a\_origin, cw\_uint32\_t a\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
