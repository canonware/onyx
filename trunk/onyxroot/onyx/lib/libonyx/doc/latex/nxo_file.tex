...
*a\_file, uint32\_t a\_len, uint8\_t *r\_str}}
	\begin{capilist}
	\item[Input(s): ]
...
*a\_file, const uint8\_t *a\_str, uint32\_t a\_len}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_arg: ]
...
uint8\_t *a\_filename, uint32\_t a\_nlen, const uint8\_t *a\_flags,
uint32\_t a\_flen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
uint8\_t **r\_origin, uint32\_t *r\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
const uint8\_t *a\_origin, uint32\_t a\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
uint8\_t *a\_str, uint32\_t a\_len, uint32\_t *r\_count}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
