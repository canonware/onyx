...
cw\_nxo\_t *a\_key, cw\_nxo\_t *r\_nxo}}
	...
	\item[Output(s): ]
		...
		\item[retval: ]
			...
			\end{description}
		\item[r\_nxo: ]
			If retval is FALSE, value associated with \cvar{a\_key}
			in \cvar{a\_nxo}, otherwise unmodified.
		\end{description}
	\item[Exception(s): ] None.
	\item[Description: ]
...
\index{\cfunc{nxo\_dict\_iterate}{}}
\citem{\cfunc[void]{nxo\_dict\_iterate}{cw\_nxo\_t *a\_nxo, cw\_nxo\_t *r\_nxo}}
	...
	\item[Output(s): ]
		\begin{description}\item[]
			...
			\end{description}
		\item[r\_nxo: ]
			If retval is FALSE, A key in \cvar{a\_nxo}, otherwise
			unmodified.
		\end{description}
	\item[Exception(s): ] None.
	\item[Description: ]
