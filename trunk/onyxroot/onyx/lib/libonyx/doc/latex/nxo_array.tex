...
\citem{\cfunc[void]{nxo\_array\_new}{cw\_nxo\_t *a\_nxo, cw\_bool\_t a\_locking,
cw\_uint32\_t a\_len}}
	\begin{capilist}
	\item[Input(s): ]
...
*a\_array, cw\_uint32\_t a\_offset, cw\_uint32\_t a\_len}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[cw\_uint32\_t]{nxo\_array\_len\_get}{const cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[cw\_bool\_t]{nxo\_array\_origin\_get}{cw\_nxo\_t *a\_nxo,
const cw\_uint8\_t **r\_origin, cw\_uint32\_t *r\_olen, cw\_uint32\_t
*r\_line\_num}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
cw\_uint8\_t *a\_origin, cw\_uint32\_t a\_olen, cw\_uint32\_t a\_line\_num}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
