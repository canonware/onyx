...
\citem{\cfunc[]{dch\_new}{cw\_dch\_t *a\_dch, cw\_mema\_t *a\_mema,
cw\_uint32\_t a\_base\_table, cw\_uint32\_t a\_base\_grow, cw\_uint32\_t
a\_base\_shrink, cw\_ch\_hash\_t *a\_hash, cw\_ch\_key\_comp\_t *a\_key\_comp}}
	\begin{capilist}
	\item[Input(s): ]
...
\citem{\cfunc[cw\_bool\_t]{dch\_shrinkable\_get}{cw\_dch\_t *a\_dch}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_dch: ]
...
\citem{\cfunc[void]{dch\_shrinkable\_set}{cw\_dch\_t *a\_dch, cw\_bool\_t
a\_shrinkable}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[cw\_bool\_t]{dch\_chi\_remove}{cw\_dch\_t *a\_dch, cw\_chi\_t
*a\_chi}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
