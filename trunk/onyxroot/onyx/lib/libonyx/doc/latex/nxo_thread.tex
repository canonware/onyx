...
*a\_threadp, const cw\_uint8\_t **r\_origin, cw\_uint32\_t *r\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
*a\_threadp, const cw\_uint8\_t *a\_origin, cw\_uint32\_t a\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
\citem{\cfunc[cw\_bool\_t]{nxo\_thread\_class\_hier\_search}{cw\_nxo\_t *a\_nxo,
...
\citem{\cfunc[cw\_bool\_t]{nxo\_thread\_tailopt\_get}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[void]{nxo\_thread\_tailopt\_set}{cw\_nxo\_t *a\_nxo, cw\_bool\_t
a\_tailopt}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
