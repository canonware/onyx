...
void	systemdict_currenterror(cw_nxo_t *a_thread);
...
void	systemdict_errordict(cw_nxo_t *a_thread);
...
void	systemdict_handleerror(cw_nxo_t *a_thread);
...
void	systemdict_userdict(cw_nxo_t *a_thread);
