...
\item{The garbage collector runs whenever a certain number of composite objects
have been created since the last collection.  This threshold can be changed or
disabled.}
