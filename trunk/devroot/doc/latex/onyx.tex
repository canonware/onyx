...
executable string that represents the code that caused the syntax error onto the
operand stack before invoking
\htmlref{\onyxop{}{syntaxerror}{}}{errordict:syntaxerror}.
...
\hline \hline
-- & {\bf \htmlref{stop}{currenterror:stop}} & -- & Last operation during error
handling. \\
\hline
-- & {\bf \htmlref{recordstacks}{currenterror:recordstacks}} & boolean & Control
stack snapshotting. \\
\hline \hline
...
\item[{\onyxop{--}{errorname}{name}}: ]
	...
	\item[Output(s): ]
		...
		\item[name: ]
			...
			\htmlref{errordict}{sec:errordict}, but .
		\end{description}
	\item[Errors(s): ] None.
	\item[Description: ]
...
\item[{\onyxop{--}{recordstacks}{boolean}}: ]
	\begin{description}\item[]
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
		\item[boolean: ]
			True if stacks are snapshotted when an error occurs;
			false otherwise.
		\end{description}
	\item[Errors(s): ] None.
	\item[Description: ]
		Get a boolean that represents whether stacks are snapshotted
		during error handling.
	\item[Example(s): ]\begin{verbatim}

onyx:0> currenterror begin
onyx:0> /recordstacks false def
onyx:0> x
Error /undefined
onyx:1> resume
onyx:1> /recordstacks true def
onyx:1> x
Error /undefined
ostack: (x)
dstack: (-dict- -dict- -dict- -dict- -dict-)
...
\item[{\onyxop{--}{collect}{--}}: ]
	...
	\item[Example(s): ]\begin{verbatim}
		...
		\end{verbatim}
	\end{description}
\label{gcdict:collections}
\index{collections@\onyxop{}{collections}{}}
\item[{\onyxop{--}{collections}{--}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
	...
	\item[Example(s): ]\begin{verbatim}
		...
		\end{verbatim}
	\end{description}
\label{gcdict:current}
\index{current@\onyxop{}{current}{}}
\item[{\onyxop{--}{current}{--}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
...
\item[{\onyxop{--}{dump}{--}}: ]
	...
	\item[Example(s): ]\begin{verbatim}
		...
		\end{verbatim}
	\end{description}
\label{gcdict:maximum}
\index{maximum@\onyxop{}{maximum}{}}
\item[{\onyxop{--}{maximum}{--}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
...
\hline \hline
-- & {\bf \htmlref{fino}{systemdict:fino}} & fino & Create a fino. \\
\hline
