...
\optableent
	...
	{output true}
	{Successfully substitute template for pattern matches.}
\optableent
...
\optableent
	...
	{{\bf \htmlref{subst}{systemdict:subst}}}
	{output true}
	{Successfully substitute.}
\optableent
	{input pattern template flags}
	{{\bf \htmlref{subst}{systemdict:subst}}}
	{false}
	{Unsuccessfully substitute template for pattern matches.}
\optableent
	{input pattern template}
	{{\bf \htmlref{subst}{systemdict:subst}}}
	{false}
...
\item[{\onyxop{OPARGS}{match}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{offsets}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{regexp}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{regsub}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{subst}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
