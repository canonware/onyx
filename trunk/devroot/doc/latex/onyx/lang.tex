...
\hline \hline
OPARGS & {\bf \htmlref{socket}{systemdict:socket}} & OPOUTS & \\
\hline
...
\hline
OPARGS & {\bf \htmlref{connect}{systemdict:connect}} & OPOUTS & \\
\hline
...
\hline
OPARGS & {\bf \htmlref{socketpair}{systemdict:socketpair}} & OPOUTS & \\
\hline
\hline \hline
...
\index{ncat@\onyxop{objects count}{ncat}{obj}}
\item[{\onyxop{OPARGS}{ncat}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[objects: ]
			\oparg{count} objects, all of one type: array, stack, or
			string.
		\item[count: ]
			Number of \oparg{objects} to catenate.
		\end{description}
	\item[Output(s): ]
		\begin{description}\item[]
		\item[obj: ]
			The catenation of \oparg{objects}.
		\end{description}
	\item[Errors(s): ]
		\begin{description}\item[]
		\item[\htmlref{rangecheck}{rangecheck}.]
		...
		\end{description}
	\item[Description: ]
		Catenate \oparg{count} \oparg{objects}.
	\item[Example(s): ]\begin{verbatim}
