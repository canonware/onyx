...
All objects have a literal, executable, or evaluable attribute associated with
...
executable, evaluable, literal, and immediately evaluated.  Executable and
evaluable names are looked up in the dictionary stack and executed (unless
...
\item[{\onyxop{proc}{bind}{proc}}: ]
	...
	\item[Description: ]
		...
		\item{The value is an executable or evaluable hook.}
