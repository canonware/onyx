...
\item[regexp: ] A regexp encapsulates a regular expression and associated flags,
...
There are two special Onyx object types that support regular expressions: regexp
and regsub.  Objects of these types are created via the
\htmlref{\onyxop{}{regexp}{}}{systemdict:regexp} and
...
\caption{Regular expression special characters} \\
\hline
...
\caption{Regular expression special sequences} \\
\hline
...
\hline
{\tt ?+} & Possessive match 0 or 1 times: {\tt \{0,1\}}. \\
\hline
{\tt *+} & Possessive match 0 or more times: {\tt \{0,\}}. \\
\hline
{\tt ++} & Possessive match 1 or more times: {\tt \{1,\}}. \\
\hline \hline
...
\hline \hline
{\tt {\bs}N} & Newline: {\tt (?{\bs}n{\pipe}{\bs}r{\pipe}{\bs}r{\bs}n)}. \\
\hline
{\tt .} & Any character but {\tt {\bs}N}: {\tt
{\lb}{\carat}{\bs}r{\bs}n{\rb}}. \\
\hline
{\tt @} & Any character: {\tt {\lb}{\bs}x00-{\bs}xff{\rb}} \\
\hline
...
\hline
{\tt {\lb}:blank:{\rb}} & Space and tab: {\tt {\lb} {\bs}t{\rb}}. \\
\hline
...
\hline
{\tt {\lb}:graph:{\rb}} & Visible character. \\
\hline
{\tt {\lb}:lower:{\rb}} & Lowercase character. \\
\hline
{\tt {\lb}:print:{\rb}} & Visible character or space: {\tt
(?{\lb}:graph:{\rb}{\pipe} )}. \\
\hline
{\tt {\lb}:punct:{\rb}} & Punctuation character. \\
\hline
{\tt {\lb}:space:{\rb}} & Whitespace: {\tt {\lb} {\bs}t{\bs}r{\bs}n{\rb}}. \\
\hline
...
\optableent
	{regexp flags}
	{{\bf \htmlref{regexptype}{outputsdict:regexptype}}}
	{string}
	{Create formatted string from regexp.}
\hline
\optableent
	{regsub flags}
...
onyx:0>
		\end{verbatim}
	\end{description}
\label{outputsdict:regexptype}
\index{regexptype@\onyxop{}{regexptype}{}}
\item[{\onyxop{regexp flags}{regexptype}{string}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[regexp: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[string: ]
			Formatted string representation of \oparg{regexp}.
		\end{description}
	\item[Errors(s): ]
		\begin{description}\item[]
		\item[\htmlref{stackunderflow}{stackunderflow}.]
		...
		\end{description}
	\item[Description: ]
		Create a formatted string representation of \oparg{regexp}.
	\item[Example(s): ]\begin{verbatim}
...
\optableent
	{regexp depth}
	{{\bf \htmlref{regexptype}{sprintsdict:regexptype}}}
	{string}
	{Create syntactical string from regexp.}
\hline
\optableent
	{regsub depth}
...
onyx:1>
		\end{verbatim}
	\end{description}
\label{sprintsdict:regexptype}
\index{regexptype@\onyxop{}{regexptype}{}}
\item[{\onyxop{regexp depth}{regexptype}{string}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[regexp: ]
	...
	\item[Output(s): ]
		\begin{description}\item[]
		\item[string: ]
			Syntactical string representation of \oparg{regexp}.
		\end{description}
	\item[Errors(s): ]
		\begin{description}\item[]
		\item[\htmlref{stackunderflow}{stackunderflow}.]
		...
		\end{description}
	\item[Description: ]
		Create a syntactical string representation of \oparg{regexp}.
	\item[Example(s): ]\begin{verbatim}
...
\optableent
	{string flags}
	{{\bf \htmlref{regexp}{systemdict:regexp}}}
	{regexp}
...
\optableent
	...
	{{\bf \htmlref{match}{systemdict:match}}}
	{matches}
	{Find regexp matches in input string.}
\hline
\optableent
	{input matches}
...
\item[{\onyxop{input regexp}{match}{matches}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[input: ]
		...
		\item[flags: ]
			...
			\begin{description}%\item[]
			\item[\$m: ] Maximum number of matches (0 is treated as
				infinity).  Defaults to 1.
			\item[\$i: ] Case insensitive.  Defaults to false.
			\item[\$o: ] Allow matches to overlap.  Defaults to
				false.
			\end{description}
		\item[regexp: ]
			A regexp object.
...
onyx:1>
		\end{verbatim}
	\end{description}
\label{systemdict:regexp}
\index{regexp@\onyxop{}{regexp}{}}
\item[{\onyxop{string flags}{regexp}{regexp}}: ]
\item[{\onyxop{string}{regexp}{regexp}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[string: ]
	...
	\item[Errors(s): ]
		...
		\end{description}
	\item[Description: ]
		Create a regexp object, according to \oparg{string} and
		\oparg{flags}.
	\item[Example(s): ]\begin{verbatim}
