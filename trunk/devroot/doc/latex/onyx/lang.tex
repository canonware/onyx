...
\item[{\onyxop{--}{gstderr}{file}}: ]
	...
	\item[Errors(s): ] None.
	\item[Description: ]
		Get the global stderr that is inherited by new threads.
	\item[Example(s): ]\begin{verbatim}
...
\item[{\onyxop{--}{gstdin}{file}}: ]
	...
	\item[Errors(s): ] None.
	\item[Description: ]
		Get the global stdin that is inherited by new threads.
	\item[Example(s): ]\begin{verbatim}
...
\item[{\onyxop{--}{gstdout}{file}}: ]
	...
	\item[Errors(s): ] None.
	\item[Description: ]
		Get the global stdout that is inherited by new threads.
	\item[Example(s): ]\begin{verbatim}
