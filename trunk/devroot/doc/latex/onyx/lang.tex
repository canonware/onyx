...
\hline
\commas obj & {\bf \htmlref{bpush}{systemdict:bpush}} & obj \commas & Push
object onto bottom of stack. \\
\hline
...
stack. \\
\hline
stack obj & {\bf \htmlref{sbpush}{systemdict:sbpush}} & -- & Push object onto
bottom of stack. \\
\hline
...
onyx:1>
		\end{verbatim}
	\end{description}
\label{systemdict:bpush}
\index{bpush@\onyxop{}{bpush}{}}
\item[{\onyxop{\commas obj}{bpush}{obj \commas}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[obj: ]
	...
	\item[Errors(s): ]
		...
		\end{description}
	\item[Description: ]
		Push \oparg{obj} onto the bottom of ostack.
	\item[Example(s): ]\begin{verbatim}

onyx:0> 1 2 3
onyx:3> 0 bpush pstack
3
2
1
0
...
\item[{\onyxop{a \dots b count}{nup}{\dots b a}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a: ]
...
\item[{\onyxop{OPARGS}{over}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{sbpush}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{under}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
