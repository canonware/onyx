...
consistent syntax.  An introductory summary of the characters that can have
special meaning within strings that specify regular expressions follows:

\begin{longtable}{\rxtableformat{5.50}}
\caption[Special characters]{Regular expression special characters} \\
\hline
...
\hline \endlastfoot
%end{latexonly}
{\tt {\bs}} & Begin a special sequence. \\
\hline
{\tt {\pipe}} & Separate alternate patterns. \\
\hline
{\tt (} & Start a group. \\
\hline
{\tt )} & End a group. \\
\hline
{\tt {\lb}} & Start a character class special sequence. \\
\hline
{\tt \{} & Start a count specification. \\
\hline
{\tt {\carat}} & Anchor to the beginning of the input/line.  Negate a
character class. \\
\hline
{\tt \$} & Anchor to the beginning of the input/line. \\
\hline
{\tt ?} & Match 0 or 1 times. \\
\hline
{\tt *} & Match 0 or more times. \\
\hline
{\tt +} & Match 1 or more times. \\
\hline
{\tt .} & Match any character but {\bs}N ({\bs}r{\bs}n or {\bs}n). \\
\hline
{\tt @} & Match any character. \\
\end{longtable}

The following sequences have special meaning within strings that specify regular
expressions:
\begin{longtable}{\rxtableformat{5.30}}
\caption[Special sequences]{Regular expression special sequences} \\
\hline
...
\hline \endlastfoot
%end{latexonly}
\multicolumn{2}{|l|}{Grouping} \\
\hline \hline
{\tt {\lb}\dots{\rb}} & Character set.  To include {\rb}, it must be {\bs}
protected.  A range is separated by {\tt -} (A-Z, a-f, 0-9, etc.), so to include
{\tt -} in a character set, place it  first. {\carat} must not come first,
unless it is the only character in the set. \\
\hline
{\tt {\lb}{\carat}\dots{\rb}} & Inverted character set. \\
\hline
{\tt (\dots)} & Capture/group. \\
{\tt (?\dots)} & Group, no capture. \\
\hline
{\tt \dots{\pipe}\dots} & Alternation, first match wins, as read left to
right. \\
\hline \hline
\multicolumn{2}{|l|}{Counting} \\
\hline \hline
{\tt \{n,m\}} & Match at least {\tt n} times, at most {\tt m} times. \\
\hline
{\tt \{n,\}} & Match at least {\tt n} times. \\
\hline
{\tt \{,m\}} & Match at most {\tt m} times: {\tt \{0,m\}}. \\
\hline
{\tt \{n\}} & Match {\tt n} times: {\tt \{n,n\}}. \\
\hline
{\tt ?} & Match 0 or 1 times: {\tt \{0,1\}}. \\
\hline
{\tt *} & Match 0 or more times: {\tt \{0,\}}. \\
\hline
{\tt ??} & Non-greedy match 0 or 1 times: {\tt \{0,1\}}. \\
\hline
{\tt *?} & Non-greedy match 0 or more times: {\tt \{0,\}}. \\
\hline
{\tt +?} & Non-greedy match 1 or more times: {\tt \{1,\}}. \\
\hline \hline
\multicolumn{2}{|l|}{Anchoring} \\
\hline \hline
{\tt {\carat}} & Anchor to beginning of input/line. \\
\hline
{\tt \$} & Anchor to end of input/line. \\
\hline
{\tt {\bs}A} & Anchor to beginning of input. \\
\hline
{\tt {\bs}Z} & Anchor to end of input. \\
\hline
{\tt {\bs}z} & Anchor to end of input, excluding {\bs}N. \\
\hline
{\tt {\bs}{\lt}} & Anchor to beginning of word boundary. \\
\hline
{\tt {\bs}{\gt}} & Anchor to end of word boundary. \\
\hline
{\tt {\bs}G} & Start where the previous match left off (or beginning of
input). \\
\hline \hline
\multicolumn{2}{|l|}{Character classes} \\
\hline \hline
{\tt {\bs}N} & Newline: {\tt (?{\bs}r{\bs}n{\pipe}{\bs}n)}. \\
\hline
{\tt .} & Any character but {\tt {\bs}N}. \\
\hline
{\tt @} & Any character. \\
\hline
{\tt {\lb}:alpha:{\rb}} & Alphabetic character. \\
\hline
{\tt {\lb}:alnum:{\rb}} & Alphanumeric character. \\
\hline
{\tt {\lb}:ascii:{\rb}} & ASCII character: {\tt {\lb}{\bs}x00-{\bs}x7f{\rb}}. \\
\hline
{\tt {\lb}:cntrl:{\rb}} & Control character: {\tt
{\lb}{\bs}x01-{\bs}x1a{\rb}}. \\
\hline
{\tt {\lb}:digit:{\rb}} & Digit character. \\
\hline
{\tt {\lb}:graph:{\rb}} & Alphanumeric or punctuation character. \\
\hline
{\tt {\lb}:lower:{\rb}} & Lowercase character. \\
\hline
{\tt {\lb}:print:{\rb}} & Alphanumeric or punctuation character. \\
\hline
{\tt {\lb}:punct:{\rb}} & Punctuation character. \\
\hline
{\tt {\lb}:space:{\rb}} & Whitespace. \\
\hline
{\tt {\lb}:upper:{\rb}} & Uppercase character. \\
\hline
{\tt {\lb}:word:{\rb}} & Word character. \\
\hline
{\tt {\lb}:xdigit:{\rb}} & Hexadecimal digit: {\tt {\lb}0-9a-fA-F{\rb}}. \\
\hline
{\tt {\lb}:\{\dots\}:{\rb}} & Evaluate Onyx code to determine character class
membership. \\
\hline \hline
\multicolumn{2}{|l|}{Character class short hands} \\
\hline \hline
{\tt {\bs}w} & Alphanumeric plus \_: {\tt {\lb}A-Za-z0-9\_{\rb}}. \\
\hline
{\tt {\bs}W} & Non-alphanumeric or \_: {\tt \lb}{\carat}A-Za-z0-9\_{\rb}. \\
\hline
{\tt {\bs}s} & Whitespace: {\tt {\lb}:space:{\rb}}. \\
\hline
{\tt {\bs}S} & Non-whitespace: {\tt {\lb}:{\carat}space:{\rb}} \\
\hline
{\tt {\bs}d} & Digit: {\tt {\lb}:digit:{\rb}} \\
\hline
{\tt {\bs}D} & Non-digit: {\tt {\lb}:{\carat}digit:{\rb}} \\
\hline
{\tt {\bs}pP} & Character with property {\tt P} (ex: {\tt {\bs}pw}). \\
\hline
{\tt {\bs}p\{P\}} & Character with property {\tt P} (ex: {\tt
{\bs}\{xdigit\}}). \\
\hline
{\tt {\bs}Pp} & Character without property {\tt p}. \\
\hline
{\tt {\bs}P\{p\}} & Character without property {\tt p}. \\
\hline
{\tt {\bs}C} & Single 8 bit byte: {\tt {\lb}{\bs}x00-{\bs}x7f{\rb}}. \\
\end{longtable}
...
\begin{longtable}{\rxtableformat{5.50}}
\caption[Special characters]{Substitution template special characters} \\
\hline
Sequence & Description \\
\hline \hline
%begin{latexonly}
...
\hline
\commas obj & {\bf \htmlref{aup}{systemdict:aup}} & obj \commas & Rotate stack
up one position. \\
\hline
obj \commas & {\bf \htmlref{adn}{systemdict:adn}} & \commas obj & Rotate stack
down one position. \\
\hline
-- & {\bf \htmlref{count}{systemdict:count}} & count & Get the number of objects
on ostack. \\
\hline
mark \dots & {\bf \htmlref{counttomark}{systemdict:counttomark}} & mark
\dots count & Get the depth of the topmost mark on ostack. \\
\hline
obj & {\bf \htmlref{dup}{systemdict:dup}} & obj dup & Duplicate an object. \\
\hline
obj \commas & {\bf \htmlref{bdup}{systemdict:bdup}} & obj \commas dup &
Duplicate bottom object. \\
\hline
objects count & {\bf \htmlref{ndup}{systemdict:ndup}} & objects objects &
Duplicate objects. \\
\hline
obj \dots index & {\bf \htmlref{idup}{systemdict:idup}} & obj \dots
dup & Duplicate object on ostack at index. \\
\hline
\dots obj \commas index & {\bf \htmlref{ibdup}{systemdict:ibdup}} & \dots
obj \commas dup & Duplicate object on ostack at index from bottom. \\
\hline
a b & {\bf \htmlref{tuck}{systemdict:tuck}} & b a b & Tuck duplicate of top
object under second object. \\
\hline
a b & {\bf \htmlref{under}{systemdict:under}} & a a b & Duplicate second
object. \\
\hline
a b & {\bf \htmlref{over}{systemdict:over}} & a b a & Duplicate second
object. \\
\hline
a b & {\bf \htmlref{exch}{systemdict:exch}} & b a & Exchange top two objects. \\
\hline
a b c & {\bf \htmlref{up}{systemdict:up}} & c a b & Roll top three objects up
one. \\
\hline
a \dots b count & {\bf \htmlref{nup}{systemdict:nup}} & b a \dots & Roll count
objects up one. \\
\hline
a b c & {\bf \htmlref{dn}{systemdict:dn}} & b c a & Roll top three objects down
one. \\
\hline
a \dots b count & {\bf \htmlref{ndn}{systemdict:ndn}} & \dots b a & Roll count
objects down one. \\
\hline
\dots amount & {\bf \htmlref{rot}{systemdict:rot}} & \dots & Rotate stack up by
\oparg{amount}. \\
\hline
region count amount & {\bf \htmlref{roll}{systemdict:roll}} & rolled & Roll
\oparg{count} objects up by \oparg{amount}. \\
\hline
obj & {\bf \htmlref{pop}{systemdict:pop}} & -- & Remove object. \\
\hline
obj \commas & {\bf \htmlref{bpop}{systemdict:bpop}} & \commas & Remove bottom
object. \\
\hline
objects count & {\bf \htmlref{npop}{systemdict:npop}} & -- & Remove count
objects. \\
\hline
objects \dots count & {\bf \htmlref{nbpop}{systemdict:nbpop}} & \dots & Remove
count objects from bottom. \\
\hline
obj \dots index & {\bf \htmlref{ipop}{systemdict:ipop}} & \dots & Remove
object at index. \\
\hline
\dots obj \commas index & {\bf \htmlref{ibpop}{systemdict:ibpop}} & \dots
\commas & Remove object at index from bottom. \\
\hline
a b & {\bf \htmlref{nip}{systemdict:nip}} & b & Remove second object. \\
\hline
...
snapshot. \\
\hline
thread & {\bf \htmlref{threadostack}{systemdict:threadostack}} & stack & Get a
reference to thread's ostack. \\
\hline \hline
\multicolumn{4}{|l|}{Execution, control, and execution stack operators} \\
\hline \hline
obj & {\bf \htmlref{eval}{systemdict:eval}} & -- & Evaluate object. \\
\hline
boolean obj & {\bf \htmlref{if}{systemdict:if}} & -- & Conditionally evaluate
object. \\
\hline
...
number of times. \\
\hline
cond proc & {\bf \htmlref{while}{systemdict:while}} & -- &  Loop while cond
is true. \\
\hline
proc cond & {\bf \htmlref{until}{systemdict:until}} & -- &  Loop until cond
is false. \\
\hline
proc & {\bf \htmlref{loop}{systemdict:loop}} & -- &  Loop indefinitely. \\
\hline
...
token. \\
file/string & {\bf \htmlref{token}{systemdict:token}} & rem obj true & \\
\hline
%end{latexonly}
\begin{htmlonly}
file/string & {\bf \htmlref{token}{systemdict:token}} & false & Scan for a
token. \\
file/string & {\bf \htmlref{token}{systemdict:token}} & file/substring obj
true & Scan for a token. \\
\end{htmlonly}
obj & {\bf \htmlref{start}{systemdict:start}} & -- & Evaluate object. \\
\hline
-- & {\bf \htmlref{quit}{systemdict:quit}} & -- & Unwind to innermost start
context. \\
\hline
obj & {\bf \htmlref{stopped}{systemdict:stopped}} & boolean & Evaluate
object. \\
\hline
-- & {\bf \htmlref{stop}{systemdict:stop}} & -- & Unwind to innermost stopped or
start context. \\
\hline
name & {\bf \htmlref{throw}{systemdict:throw}} & obj & Throw an error. \\
\hline
-- & {\bf \htmlref{estack}{systemdict:estack}} & stack & Get a current estack
snapshot. \\
\hline
thread & {\bf \htmlref{threadestack}{systemdict:threadestack}} & stack & Get a
...
snapshot. \\
\hline
thread & {\bf \htmlref{threadistack}{systemdict:threadistack}} & stack & Get a
...
execute it. \\
\hline
args & {\bf \htmlref{forkexec}{systemdict:forkexec}} & pid & Fork and exec a new
process. \\
\hline
...
\hline
stack obj & {\bf \htmlref{spush}{systemdict:spush}} & -- & Push object onto
stack. \\
\hline
stack obj & {\bf \htmlref{sbpush}{systemdict:sbpush}} & -- & Push object
...
\hline
stack & {\bf \htmlref{sbdup}{systemdict:sbdup}} & -- & Duplicate bottom
object. \\
\hline
stack count & {\bf \htmlref{sndup}{systemdict:sndup}} & -- & Duplicate objects
on stack. \\
\hline
stack index & {\bf \htmlref{sidup}{systemdict:sidup}} & -- & Duplicate object
on stack at index. \\
\hline
stack index & {\bf \htmlref{sibdup}{systemdict:sibdup}} & -- & Duplicate object
on stack at index from bottom. \\
\hline
stack & {\bf \htmlref{stuck}{systemdict:stuck}} & -- & Tuck duplicate of top
object on stack under next object on stack. \\
\hline
stack & {\bf \htmlref{sunder}{systemdict:sunder}} & -- & Duplicate second object
on stack. \\
\hline
stack & {\bf \htmlref{sover}{systemdict:sover}} & -- & Duplicate second object
on stack. \\
\hline
stack & {\bf \htmlref{sexch}{systemdict:sexch}} & -- & Exchange top objects on
stack. \\
\hline
stack & {\bf \htmlref{sup}{systemdict:sup}} & -- & Roll top three objects on
stack up one. \\
\hline
stack count & {\bf \htmlref{snup}{systemdict:snup}} & -- & Roll count objects on
stack up one. \\
\hline
stack & {\bf \htmlref{saup}{systemdict:saup}} & -- & Roll objects on stack up
one. \\
\hline
stack & {\bf \htmlref{sdn}{systemdict:sdn}} & -- & Roll top three objects on
stack down one. \\
\hline
stack count & {\bf \htmlref{sndn}{systemdict:sndn}} & -- & Roll count objects on
stack down one. \\
\hline
stack & {\bf \htmlref{sadn}{systemdict:sadn}} & -- & Roll objects on stack down
one. \\
\hline
stack amount & {\bf \htmlref{srot}{systemdict:srot}} & -- & Rotate objects on
stack up by \oparg{amount}. \\
\hline
stack count amount & {\bf \htmlref{sroll}{systemdict:sroll}} & -- & Roll objects
on stack. \\
\hline
stack & {\bf \htmlref{spop}{systemdict:spop}} & obj & Pop object off
stack. \\
\hline
stack & {\bf \htmlref{sbpop}{systemdict:sbpop}} & obj & Pop object off bottom of
stack. \\
\hline
stack count & {\bf \htmlref{snpop}{systemdict:snpop}} & array & Pop count
objects off stack. \\
\hline
stack count & {\bf \htmlref{snbpop}{systemdict:snbpop}} & array & Pop count
objects off bottom of stack. \\
\hline
stack index & {\bf \htmlref{sipop}{systemdict:sipop}} & obj & Remove object
on stack at index. \\
\hline
stack index & {\bf \htmlref{sibpop}{systemdict:sibpop}} & obj & Remove object
on stack at index from bottom. \\
\hline
stack & {\bf \htmlref{snip}{systemdict:snip}} & obj & Remove second object on
stack. \\
\hline
...
\hline
stacks count & {\bf \htmlref{ncat}{systemdict:ncat}} & stack & Catenate
stacks. \\
\hline
...
\hline
a & {\bf \htmlref{inc}{systemdict:inc}} & r & Add 1 to a. \\
\hline
a b & {\bf \htmlref{sub}{systemdict:sub}} & r & Subtract b from a. \\
\hline
a & {\bf \htmlref{dec}{systemdict:dec}} & r & Subtract 1 from a. \\
\hline
...
\hline
strings count & {\bf \htmlref{ncat}{systemdict:ncat}} & string & Catenate
strings. \\
\hline
srcstring dststring & {\bf \htmlref{copy}{systemdict:copy}} & dstsubstring &
Copy string. \\
\hline
obj depth & {\bf \htmlref{sprints}{systemdict:sprints}} & string &
Create syntactical string from object. \\
\hline
obj flags & {\bf \htmlref{outputs}{systemdict:outputs}} & string &
...
\hline
array index & {\bf \htmlref{get}{systemdict:get}} & obj & Get array
element. \\
\hline
array index obj & {\bf \htmlref{put}{systemdict:put}} & -- & Set array
element. \\
\hline
...
\hline
arrays count & {\bf \htmlref{ncat}{systemdict:ncat}} & array & Catenate
arrays. \\
\hline
...
\hline
-- & {\bf \htmlref{userdict}{systemdict:userdict}} & dict & Get userdict. \\
\hline
-- & {\bf \htmlref{globaldict}{systemdict:globaldict}} & dict & Get
globaldict. \\
\hline
-- & {\bf \htmlref{systemdict}{systemdict:systemdict}} & dict & Get
systemdict. \\
\hline
...
\hline
-- & {\bf \htmlref{threadsdict}{systemdict:threadsdict}} & dict & Get
threadsdict. \\
\hline
...
\hline
thread & {\bf \htmlref{threaddstack}{systemdict:threaddstack}} & stack & Get a
...
\hline
-- & {\bf \htmlref{pipe}{systemdict:pipe}} & rfile wfile & Create a pipe. \\
\hline
...
\hline
{\lt}file dict \dots{\gt} timeout & {\bf \htmlref{poll}{systemdict:poll}} &
...
I/O buffer. \\
\hline
file & {\bf \htmlref{nonblocking}{systemdict:nonblocking}} & boolean & Get
non-blocking mode. \\
\hline
file boolean & {\bf \htmlref{setnonblocking}{systemdict:setnonblocking}} & -- &
Set non-blocking mode. \\
\hline
%begin{latexonly}
file integer/string & {\bf \htmlref{write}{systemdict:write}} & false & Write to file. \\
file integer/string & {\bf \htmlref{write}{systemdict:write}} &
integer/substring true & \\
\hline
%end{latexonly}
\begin{htmlonly}
file integer/string & {\bf \htmlref{write}{systemdict:write}} & false & Write to
file. \\
file integer/string & {\bf \htmlref{write}{systemdict:write}} &
integer/substring true & Write to file. \\
\end{htmlonly}
string & {\bf \htmlref{print}{systemdict:print}} & -- & Print string to
stdout. \\
\hline
obj depth & {\bf \htmlref{sprint}{systemdict:sprint}} & -- & Syntactically print
object to stdout. \\
\hline
obj flags & {\bf \htmlref{output}{systemdict:output}} & -- & Formatted print
to stdout. \\
\hline
...
pointer offset. \\
\hline
path & {\bf \htmlref{mkdir}{systemdict:mkdir}} & -- & Create a directory. \\
\hline
path mode & {\bf \htmlref{mkdir}{systemdict:mkdir}} & -- & Create a directory,
mode specified. \\
\hline
path & {\bf \htmlref{mkfifo}{systemdict:mkfifo}} & -- & Create a named pipe. \\
\hline
path mode & {\bf \htmlref{mkfifo}{systemdict:mkfifo}} & -- & Create a named
pipe, mode specified. \\
\hline
...
information. \\
\hline
linkname & {\bf \htmlref{readlink}{systemdict:readlink}} & string & Get symbolic
link data. \\
...
directory. \\
\hline
path & {\bf \htmlref{chroot}{systemdict:chroot}} & -- & Change root
directory. \\
\hline
-- & {\bf \htmlref{stdin}{systemdict:stdin}} & file & Get thread's stdin. \\
\hline
-- & {\bf \htmlref{stdout}{systemdict:stdout}} & file & Get thread's stdout. \\
\hline
-- & {\bf \htmlref{stderr}{systemdict:stderr}} & file & Get thread's stderr. \\
\hline
-- & {\bf \htmlref{gstdin}{systemdict:gstdin}} & file & Get global stdin. \\
\hline
-- & {\bf \htmlref{gstdout}{systemdict:gstdout}} & file & Get global stdout. \\
\hline
-- & {\bf \htmlref{gstderr}{systemdict:gstderr}} & file & Get global stderr. \\
\hline
file & {\bf \htmlref{setstdin}{systemdict:setstdin}} & -- & Set thread's
stdin. \\
\hline
file & {\bf \htmlref{setstdout}{systemdict:setstdout}} & -- & Set thread's
stdout. \\
\hline
file & {\bf \htmlref{setstderr}{systemdict:setstderr}} & -- & Set thread's
stderr. \\
\hline
file & {\bf \htmlref{setgstdin}{systemdict:setgstdin}} & -- & Set global
stdin. \\
\hline
file & {\bf \htmlref{setgstdout}{systemdict:setgstdout}} & -- & Set global
stdout. \\
\hline
file & {\bf \htmlref{setgstderr}{systemdict:setgstderr}} & -- & Set global
stderr. \\
\hline \hline
\multicolumn{4}{|l|}{Socket and networking operators} \\
\hline \hline
family type proto & {\bf \htmlref{socket}{systemdict:socket}} & sock & Create a
socket. \\
\hline
family type & {\bf \htmlref{socket}{systemdict:socket}} & sock & Create a
socket. \\
\hline
sock addr port & {\bf \htmlref{bindsocket}{systemdict:bindsocket}} & -- & Bind
socket to address/port. \\
\hline
sock addr & {\bf \htmlref{bindsocket}{systemdict:bindsocket}} & -- & Bind
socket to address. \\
\hline
sock path & {\bf \htmlref{bindsocket}{systemdict:bindsocket}} & -- & Bind socket
to port. \\
\hline
sock backlog & {\bf \htmlref{listen}{systemdict:listen}} & -- & Listen for
socket connections. \\
\hline
sock & {\bf \htmlref{listen}{systemdict:listen}} & -- & Listen for socket
connections. \\
\hline
sock & {\bf \htmlref{accept}{systemdict:accept}} & sock & Accept a socket
connection. \\
\hline
sock addr port & {\bf \htmlref{connect}{systemdict:connect}} & -- & Connect a
socket. \\
\hline
sock path & {\bf \htmlref{connect}{systemdict:connect}} & -- & Connect a
socket. \\
\hline
service & {\bf \htmlref{serviceport}{systemdict:serviceport}} & port & Get port
number for service name. \\
\hline
sock & {\bf \htmlref{sockname}{systemdict:sockname}} & dict & Get socket
information. \\
\hline
sock level optname & {\bf \htmlref{sockopt}{systemdict:sockopt}} & optval & Get
socket option. \\
\hline
sock optname & {\bf \htmlref{sockopt}{systemdict:sockopt}} & optval & Get
socket option. \\
\hline
sock level optname optval & {\bf \htmlref{setsockopt}{systemdict:setsockopt}} &
-- & Set socket option. \\
\hline
sock optname optval & {\bf \htmlref{setsockopt}{systemdict:setsockopt}} & -- &
Set socket option. \\
\hline
sock & {\bf \htmlref{peername}{systemdict:peername}} & dict & Get peer socket
information. \\
\hline
sock mesg flags & {\bf \htmlref{send}{systemdict:send}} & nsend & Send a
message. \\
\hline
sock mesg & {\bf \htmlref{send}{systemdict:send}} & count & Send a message. \\
\hline
sock string flags & {\bf \htmlref{recv}{systemdict:recv}} & substring & Receive
a message. \\
\hline
sock string & {\bf \htmlref{recv}{systemdict:recv}} & substring & Receive a
message. \\
\hline
family type proto & {\bf \htmlref{socketpair}{systemdict:socketpair}} & sock
sock & Create a socket pair. \\
\hline
family type & {\bf \htmlref{socketpair}{systemdict:socketpair}} & sock sock &
...
\hline \hline
obj & {\bf \htmlref{type}{systemdict:type}} & name & Get object type. \\
\hline
obj & {\bf \htmlref{echeck}{systemdict:echeck}} & boolean & Evaluatable? \\
\hline
obj & {\bf \htmlref{xcheck}{systemdict:xcheck}} & boolean & Executable? \\
\hline
obj & {\bf \htmlref{cve}{systemdict:cve}} & obj & Set evaluatable attribute. \\
\hline
obj & {\bf \htmlref{cvx}{systemdict:cvx}} & obj & Set executable attribute. \\
\hline
obj & {\bf \htmlref{cvlit}{systemdict:cvlit}} & obj & Set literal attribute. \\
\hline
string & {\bf \htmlref{cvn}{systemdict:cvn}} & name & Convert string to name. \\
\hline
obj & {\bf \htmlref{cvs}{systemdict:cvs}} & string & Convert object to
string. \\
\hline
...
locking mode. \\
\hline
obj & {\bf \htmlref{lcheck}{systemdict:lcheck}} & boolean & Implicitly
locked? \\
\hline \hline
...
\item[{\onyxop{hook}{hooktag}{tag}}: ]
	...
	\item[Example(s): ]\begin{verbatim}
		...
		\end{verbatim}
	\end{description}
\label{systemdict:hostbyname}
\index{hostbyname@\onyxop{}{hostbyname}{}}
\item[{\onyxop{OPARGS}{hostbyname}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
