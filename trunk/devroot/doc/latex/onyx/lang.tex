...
down one position. \\
\hline
\dots count & {\bf \htmlref{rot}{systemdict:rot}} & \dots & Rotate stack up
count positions. \\
\hline
...
socket. \\
\hline
sock addr & {\bf \htmlref{connect}{systemdict:connect}} & -- & Connect a
socket. \\
\hline
...
\item[{\onyxop{OPARGS}{accept}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{proc}{bind}{proc}}: ]
	...
	\item[Description: ]
		...
		\htmlref{\onyxop{}{load}{}}{systemdict:load} operator.}
		\end{itemize}
	\item[Example(s): ]\begin{verbatim}
...
\item[{\onyxop{OPARGS}{bindsocket}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{connect}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{listen}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{peername}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{recv}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{send}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{setsockopt}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{socket}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{socketpair}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{sockname}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{sockopt}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
