...
scanner/parser is extremely fast.  There is also a mechanism for
\htmlref{\onyxop{}{bind}{}}{systemdict:bind}ing procedures, which makes
interpreter performance approximately the same as would be expected of a byte
code interpreter.
