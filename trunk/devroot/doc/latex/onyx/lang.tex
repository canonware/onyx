...
\hline
any & {\bf \htmlref{pop}{systemdict:pop}} & -- & Remove object. \\
\hline
any \dots & {\bf \htmlref{bpop}{systemdict:bpop}} & \dots & Remove bottom
object. \\
\hline
...
\item[{\onyxop{OPARGS}{bdup}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{bpop}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{bpush}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{ibdup}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{ibpop}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{ipop}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
...
\item[{\onyxop{OPARGS}{nbpop}{OPOUTS}}: ]
	\begin{description}\item[]
	\item[Input(s): ]
		\begin{description}\item[]
		\item[: ]
