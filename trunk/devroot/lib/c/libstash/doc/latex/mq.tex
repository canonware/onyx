...
\citem{\cfunc[cw\_bool\_t]{mq\_}{cw\_mq\_t *a\_mq, const struct timespec
*a\_timeout, ...}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\label{mq_get}
\index{\cfunc{mq\_get}{}}
\citem{\cfunc[cw\_bol\_t]{mq\_}{cw\_mq\_t *a\_mq, ...}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_mq: ]
...
\citem{\cfunc[void]{mq\_dump}{cw\_mq\_t *a\_mq, const char *a\_prefix}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_mq: ]
