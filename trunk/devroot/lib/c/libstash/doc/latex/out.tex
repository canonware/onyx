...
\citem{\cppmacro[cw\_sint32\_t]{out\_put\_f}{cw\_sint32\_t a\_fd, const char
*a\_format, ...}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
