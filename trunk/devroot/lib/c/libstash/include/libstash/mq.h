...
cw_mq_t *mq_new(cw_mq_t *a_mq);

void    mq_delete(cw_mq_t *a_mq);

void   *mq_tryget(cw_mq_t *a_mq);

void   *mq_timedget(cw_mq_t *a_mq, const struct timespec *a_timeout);

void   *mq_get(cw_mq_t *a_mq);

cw_sint32_t mq_put(cw_mq_t *a_mq, const void *a_message);
