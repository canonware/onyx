...
cw_dch_t *dch_new(cw_dch_t *a_dch, cw_uint32_t a_base_table, cw_uint32_t
    a_base_grow, cw_uint32_t a_base_shrink, cw_pezz_t *a_chi_pezz, cw_ch_hash_t
...
cw_bool_t dch_insert(cw_dch_t *a_dch, const void *a_key, const void *a_data);

cw_bool_t dch_remove(cw_dch_t *a_dch, const void *a_search_key, void **r_key,
    void **r_data);
...
cw_bool_t dch_remove_iterate(cw_dch_t *a_dch, void **r_key, void **r_data);
