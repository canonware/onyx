...
/*    dbg_register(cw_g_dbg, "pezz_verbose"); */
  ...
  _cw_out_put("sizeof(cw_kasioe_dict_t): [i]\n", sizeof(cw_kasioe_dict_t));
  _cw_out_put("sizeof(cw_kasioe_dict_t)[[[i]]: [i]\n",
	      256, _CW_KASIOE_DICT_ENTS2SIZEOF(256));
  _cw_out_put("sizeof(cw_kasioe_dict_t)[[[i]]: [i]\n", 16,
	      _CW_KASIOE_DICT_ENTS2SIZEOF(16));
  _cw_out_put("sizeof(cw_kasioe_dicto_t): [i]\n", sizeof(cw_kasioe_dicto_t));
  ...
  _cw_out_put("sizeof(cw_kasi_t): [i]\n", sizeof(cw_kasi_t));
  _cw_out_put("sizeof(cw_kasink_t): [i]\n", sizeof(cw_kasink_t));
  _cw_out_put("sizeof(cw_kasin_t): [i]\n", sizeof(cw_kasin_t));
  _cw_out_put("\n");
  
  _cw_out_put("sizeof(cw_kasit_t): [i]\n", sizeof(cw_kasit_t));
  _cw_out_put("sizeof(cw_kasitn_t): [i]\n", sizeof(cw_kasitn_t));
  _cw_out_put("\n");
