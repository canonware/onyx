...
void	systemdict_cd(cw_stilo_t *a_thread);
...
void	systemdict_ostack(cw_stilo_t *a_thread);
...
void	systemdict_pwd(cw_stilo_t *a_thread);
...
void	systemdict_rmdir(cw_stilo_t *a_thread);
...
void	systemdict_sload(cw_stilo_t *a_thread);
...
void	systemdict_sstore(cw_stilo_t *a_thread);
void	systemdict_stack(cw_stilo_t *a_thread);
void	systemdict_start(cw_stilo_t *a_thread);
void	systemdict_status(cw_stilo_t *a_thread);
