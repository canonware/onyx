...
void	systemdict_chmod(cw_stilt_t *a_stilt);
void	systemdict_chown(cw_stilt_t *a_stilt);
void	systemdict_clear(cw_stilt_t *a_stilt);
void	systemdict_cleardstack(cw_stilt_t *a_stilt);
...
void	systemdict_countdstack(cw_stilt_t *a_stilt);
void	systemdict_countestack(cw_stilt_t *a_stilt);
...
void	systemdict_currentlocking(cw_stilt_t *a_stilt);
...
void	systemdict_fino(cw_stilt_t *a_stilt);
...
void	systemdict_foreach(cw_stilt_t *a_stilt);
...
void	systemdict_lcheck(cw_stilt_t *a_stilt);
void	systemdict_le(cw_stilt_t *a_stilt);
void	systemdict_length(cw_stilt_t *a_stilt);
void	systemdict_link(cw_stilt_t *a_stilt);
...
void	systemdict_mkdir(cw_stilt_t *a_stilt);
...
void	systemdict_nsleep(cw_stilt_t *a_stilt);
...
void	systemdict_sym_rb_gt(cw_stilt_t *a_stilt);
...
void	systemdict_truncate(cw_stilt_t *a_stilt);
...
void	systemdict_unlink(cw_stilt_t *a_stilt);
