...
struct cw_stilt_s
{
  ...
  /* Hash of cached stiln references.  Keys are (cw_stilnk_t *), direct hashed;
   * values are (cw_stiltn_t *). */
  cw_dch_t stiln_dch;
  ...
  /* If greater than _CW_STIL_BUFC_SIZE, tok_buffer is a buf.  Otherwise, it
...
struct cw_stiltn_s
{
  ...
  /* Key.  This is a copy of the stilnk in the main stil's names hash.  The
