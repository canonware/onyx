...
passing a file \classname{nxo} to \cfunc{nxo_string_get}{} is prohibited, and
...
\citem{\cfunc[cw\_sint32\_t]{nxo\_compare}{cw\_nxo\_t *a\_a, cw\_nxo\_t *a\_b}}
	...
	\end{capilist}
\label{nxo_dup}
\index{\cppmacro{nxo\_dup}{}}
\citem{\cppmacro[void]{nxo\_dup}{cw\_nxo\_t *a\_to, cw\_nxo\_t *a\_from}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_to: ]
	...
	\end{capilist}
\label{nxo_type_get}
\index{\cppmacro{nxo\_type\_get}{}}
\citem{\cppmacro[cw\_nxot\_t]{nxo\_type\_get}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[cw\_bool\_t]{nxo\_lcheck}{}}
	...
	\end{capilist}
\label{nxo_attr_get}
\index{\cppmacro{nxo\_attr\_get}{}}
\citem{\cppmacro[cw\_nxoa\_t]{nxo\_attr\_get}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
	...
	\end{capilist}
\label{nxo_attr_get}
\index{\cppmacro{nxo\_attr\_set}{}}
\citem{\cppmacro[void]{nxo\_attr\_set}{cw\_nxo\_t *a\_nxo, cw\_nxoa\_t a\_attr}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
