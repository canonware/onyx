...
\index{nxo_threadp_origin_get@\cfunc{nxo\_threadp\_origin\_get}{}}
\citem{\cfunc[void]{nxo\_threadp\_origin\_get}{const cw\_nxo\_threadp\_t
*a\_threadp, const uint8\_t **r\_origin, uint32\_t *r\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
\index{nxo_threadp_origin_set@\cfunc{nxo\_threadp\_origin\_set}{}}
\citem{\cfunc[void]{nxo\_threadp\_origin\_set}{cw\_nxo\_threadp\_t
*a\_threadp, const uint8\_t *a\_origin, uint32\_t a\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
	...
	\item[Description: ]
		...
		\cvar{a\_origin}, so the string must exist for the entire time
		that \cvar{a\_threadp} retains a reference to the string.
	\end{capilist}
...
*a\_threadp, uint32\_t *r\_line, uint32\_t *r\_column}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
*a\_threadp, uint32\_t a\_line, uint32\_t a\_column}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
\citem{\cfunc[bool]{nxo\_thread\_deferred}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
cw\_nxo\_threadp\_t *a\_threadp, const uint8\_t *a\_str, uint32\_t
a\_len}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxo\_thread\_serror}{cw\_nxo\_t *a\_nxo, const uint8\_t
a\_str, uint32\_t a\_len}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[bool]{nxo\_thread\_dstack\_search}{cw\_nxo\_t *a\_nxo,
...
\index{nxo_thread_class_hier_search@\cfunc{nxo\_thread\_class\_hier\_search}{}}
\citem{\cfunc[bool]{nxo\_thread\_class\_hier\_search}{cw\_nxo\_t *a\_nxo,
cw\_nxo\_t *a\_class, cw\_nxo\_t *a\_key, cw\_nxo\_t *r\_value}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
	...
	\item[Output(s): ]
		...
		\item[retval: ]
			...
			\item[false: ]
				Success.
			\item[true: ]
				\cvar{a\_key} not found on in
				\cvar{a\_class}'s class hierarchy.
			\end{description}
		\item[r\_value: ]
			Value in \cvar{a\_class}'s class hierarchy farthest
			from the base class that is associated with
			\cvar{a\_key}.
		\end{description}
	\item[Exception(s): ] None.
	\item[Description: ]
		Search \cvar{a\_class}'s class hierarchy for the definition
		of \cvar{a\_key} that is farthest from the base class.
	\end{capilist}
\label{nxo_thread_currentlocking}
\index{nxo_thread_currentlocking@\cfunc{nxo\_thread\_currentlocking}{}}
\citem{\cfunc[bool]{nxo\_thread\_currentlocking}{const cw\_nxo\_t
*a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxo\_thread\_setlocking}{cw\_nxo\_t *a\_nxo, bool
a\_locking}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\index{nxo_thread_maxestack_get@\cfunc{nxo\_thread\_maxestack\_get}{}}
\citem{\cfunc[cw\_nxoi\_t]{nxo\_thread\_maxestack\_get}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Return \cvar{a\_nxo}'s maximum allowable estack depth.
	\end{capilist}
\label{nxo_thread_maxestack_set}
\index{nxo_thread_maxestack_set@\cfunc{nxo\_thread\_maxestack\_set}{}}
\citem{\cfunc[void]{nxo\_thread\_maxestack\_set}{cw\_nxo\_t *a\_nxo, cw\_nxoi\_t
a\_maxestack}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Set \cvar{a\_nxo}'s maximum allowable estack depth to
		\cvar{a\_maxestack}.
	\end{capilist}
\label{nxo_thread_tailopt_get}
\index{nxo_thread_tailopt_get@\cfunc{nxo\_thread\_tailopt\_get}{}}
\citem{\cfunc[bool]{nxo\_thread\_tailopt\_get}{cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Return \cvar{a\_nxo}'s tail optimization setting.
	\end{capilist}
\label{nxo_thread_tailopt_set}
\index{nxo_thread_tailopt_set@\cfunc{nxo\_thread\_tailopt\_set}{}}
\citem{\cfunc[void]{nxo\_thread\_tailopt\_set}{cw\_nxo\_t *a\_nxo, bool
a\_tailopt}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
	...
	\item[Exception(s): ] None.
	\item[Description: ]
		Set \cvar{a\_nxo}'s tail optimization setting to
		\cvar{a\_tailopt}.
	\end{capilist}
