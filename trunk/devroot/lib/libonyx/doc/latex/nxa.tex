...
\citem{\cfunc[void *]{nxa\_malloc\_e}{void *a\_arg, size\_t a\_size, const
char *a\_filename, cw\_uint32\_t a\_line\_num}}
\label{nxa_malloc}
\index{nxa_malloc@\cfunc{nxa\_malloc}{}}
\citem{\cfunc[void *]{nxa\_malloc}{size\_t a\_size}}
	\begin{capilist}
	\item[Input(s): ]
	...
	\end{capilist}
\label{nxa_calloc_e}
\index{nxa_calloc_e@\cfunc{nxa\_calloc\_e}{}}
\citem{\cfunc[void *]{nxa\_calloc\_e}{void *a\_arg, size\_t a\_number,
size\_t a\_size, const char *a\_filename, cw\_uint32\_t a\_line\_num}}
\label{nxa_calloc}
\index{nxa_calloc@\cfunc{nxa\_calloc}{}}
\citem{\cfunc[void *]{nxa\_calloc}{size\_t a\_number, size\_t a\_size}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_arg: ]
...
\citem{\cfunc[void *]{nxa\_realloc\_e}{void *a\_arg, void *a\_ptr, size\_t
a\_size, size\_t a\_old\_size, const char *a\_filename, cw\_uint32\_t
a\_line\_num}}
\label{nxa_realloc}
\index{nxa_realloc@\cfunc{nxa\_realloc}{}}
\citem{\cfunc[void *]{nxa\_realloc}{void *a\_ptr, size\_t a\_size, size\_t
a\_old\_size}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void *]{nxa\_free\_e}{void *a\_arg, void *a\_ptr, size\_t a\_size,
const char *a\_filename, cw\_uint32\_t a\_line\_num}}
\label{nxa_free}
\index{nxa_free@\cfunc{nxa\_free}{}}
\citem{\cfunc[void *]{nxa\_free}{void *a\_ptr, size\_t a\_size}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_arg: ]
...
\citem{\cfunc[void]{nxa\_collect}{void}}
	\begin{capilist}
	\item[Input(s): ] None.
	\item[Output(s): ] None.
	\item[Exception(s): ]
...
\citem{\cfunc[cw\_bool\_t]{nxa\_active\_get}{void}}
	\begin{capilist}
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxa\_active\_set}{cw\_bool\_t a\_active}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_active: ]
...
\citem{\cfunc[cw\_nxoi\_t]{nxa\_period\_get}{void}}
	\begin{capilist}
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxa\_period\_set}{cw\_nxoi\_t a\_period}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_period: ]
...
\citem{\cfunc[cw\_nxoi\_t]{nxa\_threshold\_get}{void}}
	\begin{capilist}
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxa\_threshold\_set}{cw\_nxoi\_t a\_threshold}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threshold: ]
...
\citem{\cfunc[void]{nxa\_stats\_get}{cw\_nxoi\_t *r\_collections, cw\_nxoi\_t
*r\_count, cw\_nxoi\_t *r\_ccount, cw\_nxoi\_t *r\_cmark, cw\_nxoi\_t
*r\_csweep, cw\_nxoi\_t *r\_mcount, cw\_nxoi\_t *r\_mmark, cw\_nxoi\_t
*r\_msweep, cw\_nxoi\_t *r\_scount, cw\_nxoi\_t *r\_smark, cw\_nxoi\_t
*r\_ssweep}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
