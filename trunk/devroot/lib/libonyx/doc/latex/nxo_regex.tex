...
*a\_thread, cw\_uint32\_t a\_limit, cw\_nxo\_t *a\_input, cw\_nxo\_t *r\_array}}
	...
	\item[Description: ]
		...
		substrings are also created for those capturing subpatterns and
		inserted into the substring array.

		As a special case, if the regular expression matches the empty
		string, a single character is split.  This avoids an infinite
		loop.
