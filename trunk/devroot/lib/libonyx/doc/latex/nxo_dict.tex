...
\citem{\cfunc[void]{nxo\_dict\_new}{cw\_nxo\_t *a\_nxo, cw\_bool\_t a\_locking,
cw\_uint32\_t a\_dict\_size}}
	\begin{capilist}
	\item[Input(s): ]
...
\citem{\cfunc[void]{nxo\_dict\_def}{cw\_nxo\_t *a\_nxo, cw\_nxo\_t *a\_key,
cw\_nxo\_t *a\_val}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxo\_dict\_undef}{cw\_nxo\_t *a\_nxo, cw\_nxo\_t *a\_key}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[cw\_bool\_t]{nxo\_dict\_lookup}{const cw\_nxo\_t *a\_nxo, const
...
\citem{\cfunc[cw\_uint32\_t]{nxo\_dict\_count}{const cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
