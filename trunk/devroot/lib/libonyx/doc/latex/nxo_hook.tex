...
\citem{\cfunc[cw\_bool\_t]{cw\_nxo\_hook\_delete\_t}{void *a\_data,
...
\citem{\cfunc[void]{nxo\_hook\_new}{cw\_nxo\_t *a\_nxo, void *a\_data,
cw\_nxo\_hook\_eval\_t *a\_eval\_f, cw\_nxo\_hook\_ref\_iter\_t
...
\citem{\cfunc[cw\_nxo\_t *]{nxo\_hook\_tag\_get}{const cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\citem{\cfunc[void *]{nxo\_hook\_data\_get}{const cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
...
\index{nxo_hook_data_set@\cfunc{nxo\_hook\_data\_set}{}}
\citem{\cfunc[void]{nxo\_hook\_data\_set}{cw\_nxo\_t *a\_nxo, void *a\_data}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
