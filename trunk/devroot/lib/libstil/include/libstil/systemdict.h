...
void	systemdict_ceiling(cw_stilt_t *a_stilt);
...
void	systemdict_currentaccuracy(cw_stilt_t *a_stilt);
void	systemdict_currentbase(cw_stilt_t *a_stilt);
...
void	systemdict_currentmstate(cw_stilt_t *a_stilt);
void	systemdict_currentobjectformat(cw_stilt_t *a_stilt);
void	systemdict_currentpoint(cw_stilt_t *a_stilt);
...
void	systemdict_floor(cw_stilt_t *a_stilt);
...
void	systemdict_initmath(cw_stilt_t *a_stilt);
...
void	systemdict_mrestore(cw_stilt_t *a_stilt);
void	systemdict_mrestoreall(cw_stilt_t *a_stilt);
void	systemdict_msave(cw_stilt_t *a_stilt);
void	systemdict_mstate(cw_stilt_t *a_stilt);
...
void	systemdict_readhexstring(cw_stilt_t *a_stilt);
...
void	systemdict_resetfile(cw_stilt_t *a_stilt);
...
void	systemdict_setaccuracy(cw_stilt_t *a_stilt);
void	systemdict_setbase(cw_stilt_t *a_stilt);
void	systemdict_setfileposition(cw_stilt_t *a_stilt);
void	systemdict_setglobal(cw_stilt_t *a_stilt);
void	systemdict_setmstate(cw_stilt_t *a_stilt);
void	systemdict_setobjectformat(cw_stilt_t *a_stilt);
void	systemdict_setpoint(cw_stilt_t *a_stilt);
void	systemdict_shift(cw_stilt_t *a_stilt);
void	systemdict_sqrt(cw_stilt_t *a_stilt);
...
void	systemdict_writehexstring(cw_stilt_t *a_stilt);
void	systemdict_writeobject(cw_stilt_t *a_stilt);
