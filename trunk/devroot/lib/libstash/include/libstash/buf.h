...
cw_bool_t	buf_catenate_buf(cw_buf_t *a_a, cw_buf_t *a_b, cw_bool_t
    a_preserve);
...
cw_bool_t	buf_set_uint32(cw_buf_t *a_buf, cw_uint32_t a_offset,
    cw_uint32_t a_val);

cw_bool_t	buf_set_uint64(cw_buf_t *a_buf, cw_uint32_t a_offset,
    cw_uint64_t a_val);
