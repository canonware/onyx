...
/*    dbg_register(cw_g_dbg, "mem_verbose"); */
  ...
  /* arena_new(), arena_new_r(), arena_delete(), arena_get_chunk_size(),
   * arena_get_max_chunks(). */
  {
  ...
  /* Check single allocation larger than chunk size (should return NULL). */
  {
    cw_arena_t arena;
    void *pointer;
