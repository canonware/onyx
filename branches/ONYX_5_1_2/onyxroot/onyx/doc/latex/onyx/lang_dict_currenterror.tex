...
\optableent
	{--}
	{{\bf \htmlref{origin}{currenterror:origin}}}
	{string/null}
...
\optableent
	{--}
	{{\bf \htmlref{cstack}{currenterror:cstack}}}
	{stack}
	{cstack snaphot.}
\hline
\optableent
...
\item[{\onyxop{--}{cstack}{stack}}: ]
	...
	\item[Error(s): ] None.
	\item[Description: ]
		Get a stack that is a cstack snapshot as of the most recent
		error.
	\item[Example(s): ]\begin{verbatim}
...
onyx:5>
		\end{verbatim}
	\end{description}
\label{currenterror:origin}
\index{origin@\onyxop{}{origin}{}}
\item[{\onyxop{--}{origin}{string/null}}: ]
	\begin{description}\item[]
	\item[Input(s): ] None.
	\item[Output(s): ]
		\begin{description}\item[]
		\item[string/null: ]
			Origin string if the error was a syntaxerror, null
			otherwise.
		\end{description}
	\item[Error(s): ] None.
	\item[Description: ]
