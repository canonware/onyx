...
*a\_threadp, const char **r\_origin, uint32\_t *r\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
*a\_threadp, const char *a\_origin, uint32\_t a\_olen}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_threadp: ]
...
cw\_nxo\_threadp\_t *a\_threadp, const char *a\_str, uint32\_t
a\_len}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void]{nxo\_thread\_serror}{cw\_nxo\_t *a\_nxo, const char
