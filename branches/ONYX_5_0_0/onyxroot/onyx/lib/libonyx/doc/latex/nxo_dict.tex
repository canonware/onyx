...
\citem{\cfunc[void]{nxo\_dict\_new}{cw\_nxo\_t *a\_nxo, bool a\_locking,
uint32\_t a\_dict\_size}}
	\begin{capilist}
	\item[Input(s): ]
...
\citem{\cfunc[bool]{nxo\_dict\_lookup}{const cw\_nxo\_t *a\_nxo, const
...
\citem{\cfunc[uint32\_t]{nxo\_dict\_count}{const cw\_nxo\_t *a\_nxo}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxo: ]
