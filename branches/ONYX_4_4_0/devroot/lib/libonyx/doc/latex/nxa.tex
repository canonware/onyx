...
\citem{\cfunc[void *]{nxa\_calloc\_e}{cw\_nxa\_t *a\_nxa, size\_t a\_number,
size\_t a\_size, const char *a\_filename, cw\_uint32\_t a\_line\_num}}
\label{nxa_calloc}
\index{nxa_calloc@\cfunc{nxa\_calloc}{}}
\citem{\cfunc[void *]{nxa\_calloc}{cw\_nxa\_t *a\_nxa, size\_t a\_number,
size\_t a\_size}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
...
\citem{\cfunc[void *]{nxa\_realloc\_e}{cw\_nxa\_t *a\_nxa, void *a\_ptr, size\_t
a\_size, size\_t a\_old\_size, const char *a\_filename, cw\_uint32\_t
a\_line\_num}}
\label{nxa_realloc}
\index{nxa_realloc@\cfunc{nxa\_realloc}{}}
\citem{\cfunc[void *]{nxa\_realloc}{cw\_nxa\_t *a\_nxa, void *a\_ptr, size\_t
a\_size, size\_t a\_old\_size}}
	\begin{capilist}
	\item[Input(s): ]
		\begin{description}\item[]
		\item[a\_nxa: ]
