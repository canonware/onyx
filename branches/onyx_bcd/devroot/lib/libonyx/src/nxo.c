...
static const cw_nxot_vtable_t nxot_vtable[] = {
    ...
    /* NXOT_ARRAY */
    {nxoe_l_array_delete, nxoe_l_array_ref_iter},
...
#ifdef CW_THREADS
    /* NXOT_CONDITION */
    {nxoe_l_condition_delete, nxoe_l_condition_ref_iter},
#endif
	
    /* NXOT_DICT */
    {nxoe_l_dict_delete, nxoe_l_dict_ref_iter},

    /* NXOT_FILE */
    {nxoe_l_file_delete, nxoe_l_file_ref_iter},
...
#ifdef CW_THREADS
    /* NXOT_MUTEX */
    {nxoe_l_mutex_delete, nxoe_l_mutex_ref_iter},
#endif

    /* NXOT_NAME */
    {nxoe_l_name_delete, nxoe_l_name_ref_iter},
    ...
    /* NXOT_STRING */
    {nxoe_l_string_delete, nxoe_l_string_ref_iter},

    /* NXOT_THREAD */
    {nxoe_l_thread_delete, nxoe_l_thread_ref_iter}
};
...
{
    cw_check_ptr(a_nxoe);
    cw_dassert(a_nxoe->magic == CW_NXOE_MAGIC);
