...
#ifdef CW_POSIX_FILE
cw_nxn_t nxo_file_open(cw_nxo_t *a_nxo, const cw_uint8_t *a_filename,
...
cw_sint32_t nxo_file_read(cw_nxo_t *a_nxo, cw_uint32_t a_len, cw_uint8_t
    *r_str);
cw_nxn_t nxo_file_readline(cw_nxo_t *a_nxo, cw_bool_t a_locking, cw_nxo_t
    *r_string, cw_bool_t *r_eof);
cw_nxn_t nxo_file_write(cw_nxo_t *a_nxo, const cw_uint8_t *a_str, cw_uint32_t
    a_len);
#ifdef CW_POSIX_FILE
